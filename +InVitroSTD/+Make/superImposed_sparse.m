function sig = superImposed_sparse(sinSignal,secondSignal,seperationPoints,ifRandom,numberPhases,ifConst)
...
if isempty(seperationPoints)
    ...
    seperationPoints = seperationPoints(1:2:length(seperationPoints));
end
